...
print("e2w:", event2word)
print("w2e:", word2event)
...
class NewsDataset(Dataset):
    ...
    def prepare_data(self, midi_paths):
        # extract events
        all_events = []
        pbar = tqdm(midi_paths)
        pbar.set_description("Extract Events")
        for path in pbar:
...
def train(is_continue = False, checkpoints_path = ''):
    ...
    train_list = glob.glob('../Pop1K7/midi_analyzed/src_*/*.mid')
